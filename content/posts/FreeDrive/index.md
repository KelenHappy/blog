...
date: 2026-08-12
draft: false
descrition: "Google帳號可以申請到的免費網路空間"
---
# 前言
...
**分享與下載限制：**
*   可以建立檔案或資料夾分享連結，但下載需要輸入自己的email。
...
**分享與下載限制：**
*   沒有檔案大小限制，可以建立分享連結，但是`每月分享流量限制為100GB`和`只能被讀取10次`。
...
**分享與下載限制：**
*   沒有檔案大小限制，可以建立檔案或資料夾分享連結，但免費帳戶的上傳和下載速度可能不穩定。
